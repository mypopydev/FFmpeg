...
static const AVOption stackblur_options[] = {
    { "radius", "Radius of the stack blurring box", OFFSET(radius),  AV_OPT_TYPE_INT, {.i64 = 2}, 1, 179, FLAGS },
    { "r",      "Radius of the stack blurring box", OFFSET(radius),  AV_OPT_TYPE_INT, {.i64 = 2}, 1, 179, FLAGS },
    { NULL }
};
